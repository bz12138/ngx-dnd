import { Injectable, NgModule, Directive, Input, Output, ElementRef, EventEmitter, Renderer2, HostListener, Component, ViewEncapsulation, ContentChild, TemplateRef, ViewChild, HostBinding, defineInjectable } from '@angular/core';
...
class ContainerComponent {
     ...
     */
    styleString(item) {
        const /** @type {?} */ itemStyle = typeof this.droppableItemStyle === 'function' ? this.droppableItemStyle(item) : this.droppableItemStyle;
